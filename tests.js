...
var Container = {
	...
	"sceneInterface": require('../interfaces/sceneInterface'),
	"coreInterface": require('../interfaces/coreUserInterface')
};

module.exports = Container;
},{"../input/CommandsInput":5,"../interfaces/coreUserInterface":7,"../interfaces/sceneInterface":8}],3:[function(require,module,exports){
var $ = require('jquery');
var game = require('../game/GameController');
...
describe("GameLoader", function() {
	...
	describe("#save()", function() {
		it('should put the object in a new property in localStorage', function() {
			...
			expect(gameLoader.getSaveData("test")).to.be.an("object");
			expect(gameLoader.getSaveData("test")).to.have.property("name", "test");
		});
	});
...
},{"../../js/GameLoader.js":1,"../../js/game/data/saveSchema":16}]},{},[22])